...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "outcome", sa.Enum("success", "denied", "error", name="audit_outcome"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("active", "suspended", "locked", name="user_status"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_type",
            sa.Enum("exterior", "cockpit", "subsystem", "environment", name="asset_type"),
            nullable=False,
        ),
        sa.Column(
            "fidelity", sa.Enum("low", "medium", "high", name="asset_fidelity"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            sa.Enum("fcom", "qrh", "amm", "sop", "syllabus", name="content_source_type"),
            nullable=False,
        ),
        sa.Column("aircraft_id", sa.UUID(), nullable=True),
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "approved", "archived", name="content_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mode",
            sa.Enum("challenge_response", "read_do", "do_verify", name="checklist_mode"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("in_progress", "completed", "aborted", name="checklist_session_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_content_sections_source_id"), "content_sections", ["source_id"], unique=False
    )
    op.create_table(
        "content_references",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_content_references_citation_key"),
        "content_references",
        ["citation_key"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            "procedure_type",
            sa.Enum("normal", "abnormal", "emergency", name="procedure_type"),
            nullable=False,
        ),
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column("phase", sa.String(length=64), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["citation_key"],
            ["content_references.citation_key"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("in_progress", "completed", "aborted", name="proc_session_status"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["procedure_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "mode",
            sa.Enum("challenge_response", "read_do", "do_verify", name="step_mode"),
            nullable=False,
        ),
        sa.Column("target_time_seconds", sa.Integer(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "scenario_type",
            sa.Enum(
                "v1_cut", "windshear", "tcas_ra", "engine_fire", "custom", name="scenario_type"
            ),
            nullable=False,
        ),
        sa.Column("aircraft_id", sa.UUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("minor", "moderate", "major", "critical", name="deviation_severity"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("in_progress", "completed", "aborted", name="scenario_session_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("in_progress", "completed", "aborted", name="training_session_status"),
            nullable=False,
        ),
        sa.Column("metadata_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_session_events_timestamp"), "session_events", ["timestamp"], unique=False
    )
    op.create_table(
        "vr_sessions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_vr_telemetry_events_timestamp"), "vr_telemetry_events", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_vr_telemetry_events_vr_session_id"),
        "vr_telemetry_events",
        ["vr_session_id"],
        unique=False,
    )
