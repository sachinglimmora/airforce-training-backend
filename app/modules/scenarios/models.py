...
class ScenarioSession(Base):
    ...
    status: Mapped[str] = mapped_column(
        Enum("in_progress", "completed", "aborted", name="scenario_session_status"), default="in_progress"
    )
    trigger_fired_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
