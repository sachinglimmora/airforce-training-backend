...
from app.modules.training.schemas import CourseOut, ModuleOut, ModuleCreate, CourseCreate, ModuleUpdate
...
async def generate_video(
    ...
    return {"data": {"message": "Generation started", "videoStatus": "processing", "moduleId": str(module_id)}}
